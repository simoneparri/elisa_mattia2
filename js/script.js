(function($) {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2024/09/06', function(event) {
            var $this = $(this).html(event.strftime(''
            + '<div class="box"><div>%D</div> <span>Giorni</span> </div>'
            + '<div class="box"><div>%H</div> <span>Ore</span> </div>'
            + '<div class="box"><div>%M</div> <span>Minuti</span> </div>'
            + '<div class="box"><div>%S</div> <span>Secondi</span> </div>'));
        });
    }
